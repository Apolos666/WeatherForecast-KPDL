...
const FourthPattern = () => {
  ...
  const correlationValues = [
    [1, data[0].tempCHumidityCorrelation, data[0].tempCPressureMbCorrelation, data[0].tempCWindKphCorrelation, data[0].tempCCloudCorrelation],
    [data[0].humidityTempCCorrelation, 1, data[0].humidityPressureMbCorrelation, data[0].humidityWindKphCorrelation, data[0].humidityCloudCorrelation],
    [data[0].pressureMbTempCCorrelation, data[0].pressureMbHumidityCorrelation, 1, data[0].pressureMbWindKphCorrelation, data[0].pressureMbCloudCorrelation],
    [data[0].windKphTempCCorrelation, data[0].windKphHumidityCorrelation, data[0].windKphPressureMbCorrelation, 1, data[0].windKphCloudCorrelation],
    [data[0].cloudTempCCorrelation, data[0].cloudHumidityCorrelation, data[0].cloudPressureMbCorrelation, data[0].cloudWindKphCorrelation, 1]
  ];
   ...
   <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex flex-col items-center justify-center p-6 flex-grow">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Heatmap thể hiện mối quan hệ giữa các biến thời tiết, từ tương quan
            âm (-1) đến tương quan dương (1).
          </p>
        </div>
      ...
      <footer className="bg-gray-200 text-center py-4">
        <p className="text-sm text-gray-600">
          © 2024 Weather Analysis. Được phát triển bởi bạn.
        </p>
      </footer>
    </div>
  );
