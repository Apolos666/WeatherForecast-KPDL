...
import useGetRawWeeklyData from '../../../../../hooks/useGetRawWeeklyData';
...
const RawWeeklyDate = () => {
  ...
  const { getRawData, loading } = useGetRawWeeklyData(weekRange);
      ...
      <div className="p-8 h-full w-full bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 space-y-10">
        <div className="flex justify-between items-center bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-lg shadow-md">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl font-bold">Weekly Data Insights</h1>
            <p className="text-sm mt-1">
              Quickly analyze data by selecting your preferred week range.
            </p>
          </div>
          <Select
            options={options}
        ...
        <div className="grid md:grid-cols-3">
          <div className="col-span-1 bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-tl-lg rounded-bl-lg">
            <h2 className="flex flex-row text-3xl font-semibold text-blue-800 mb-4">
              <span>Temperature Weekly Weather Overview</span>
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Explore weekly temperature data, including trends in average,
              maximum, and minimum temperatures. Use this information to make
              informed decisions and optimize your weekly planning. The chart on
        ...
        <div className="grid md:grid-cols-3">
          ...
          <div className="col-span-1 bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-tr-lg rounded-br-lg">
            <h2 className="text-3xl font-semibold text-blue-800 mb-4">
              Humidity Weekly Weather Overview
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Explore weekly humidity data, including trends in average humidity
              levels. Use this information to make informed decisions and
              optimize your weekly planning. The chart on the left visualizes
        ...
        <div className="grid md:grid-cols-3">
          <div className="col-span-1 bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-tl-lg rounded-bl-lg">
            <h2 className="text-3xl font-semibold text-blue-800 mb-4">
              Pressure Weekly Weather Overview
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Explore weekly pressure data, including trends in average
              pressure. Use this information to make informed decisions and
              optimize your weekly planning. The chart on the right visualizes
        ...
        <div className="grid md:grid-cols-3">
          ...
          <div className="col-span-1 bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-tr-lg rounded-br-lg">
            <h2 className="text-3xl font-semibold text-blue-800 mb-4">
              Wind Speed Weekly Weather Overview
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Explore weekly wind speed data, including trends in average and
              max wind speed. Use this information to make informed decisions
              and optimize your weekly planning. The chart on the left
